function edit_row(no)
{
 ...
 trade.innerHTML="<input type='text' id='trade_text"+no+"' value='"+trade_data+"' style='width: 100%;'>";
...
function add_row()
{
 ...
 var row = table.insertRow(table_len).outerHTML="<tr id='row"+table_len+"'><td class='tableData' id='trade_row"+table_len+"'>"+new_trade+"</td><td  class='tableData' id='security_row"+table_len+"'>"+new_security+"</td><td  class='tableData' id='quantity_row"+table_len+"'>"+new_quantity+"</td><td  class='tableData' id='price_row"+table_len+"'>"+new_price+"</td><td  class='tableData' id='buyer_row"+table_len+"'>"+new_buyer+"</td><td  class='tableData' id='seller"+table_len+"'>"+new_seller+"</td><td class='buttons'><input type='button' id='edit_button"+table_len+"' value='Edit' class='edit' onclick='edit_row("+table_len+")'> <input type='button' id='save_button"+table_len+"' value='Save' class='save' onclick='save_row("+table_len+")'> <input type='button' value='Delete' class='delete' onclick='delete_row("+table_len+")'></td></tr>";
document.getElementById("save_button"+no).style.display="block";
